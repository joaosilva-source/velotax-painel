          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold text-[#000058]">Aumento de Limite Pix</h2>
              </div>
              <p className="text-sm text-black/70">
                Solicitar aumento de limite PIX informando valor e CPF do cliente.
              </p>
              <div className="mt-auto text-xs text-violet-700 font-medium">Abrir painel →</div>
            </a>
