      ...
      <div className="min-h-screen container-pad py-10">
        <div className="max-w-6xl mx-auto animate-fadeUp">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <a href="/consulta-cpf-conecta" className="block card hover:-translate-y-0.5 p-4 text-center">
              <div className="text-lg font-semibold mb-1">Consulta CPF – Ação Conecta Mais</div>
              <div className="text-black/70">Buscar CPF na lista Ação Conecta Mais</div>
            </a>
